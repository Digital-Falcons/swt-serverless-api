...
export type ParamType = 'body' | 'query' | 'param' | 'header' | 'ctx' | 'req' | 'ctx.get' | 'env';
...
export type SWTZodSchema = ZodStringSchema | ZodNumberSchema | ZodBooleanSchema | ZodObjectSchema | ZodArraySchema;
